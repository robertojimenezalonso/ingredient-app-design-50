      ...
      <div className="relative z-10 min-h-screen flex flex-col">
        ...
        <div className="fixed bottom-0 left-0 right-0 p-4">
          <div className="flex items-center justify-between mb-4">
            ...
            <Button onClick={handleContinue} disabled={!canContinue} className="px-8 bg-foreground text-background hover:bg-foreground/90 disabled:opacity-100 disabled:bg-[#81838B] disabled:text-white rounded-lg py-3 h-auto text-lg font-semibold">
              Siguiente
            </Button>
          </div>
        </div>
