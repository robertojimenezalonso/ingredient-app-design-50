...
const CalendarSelectionPage = () => {
  ...
  const handleDateSelect = (date: Date | undefined) => {
    ...
    } else if (selectedDates.length < 31) { // Maximum 1 month
    ...
    <div className="min-h-screen relative">
      ...
      <div className="absolute inset-0 bg-background flex flex-col items-center justify-center p-4">
        <div className="w-full max-w-sm">
          ...
          <Button 
            className="w-full bg-white rounded-full shadow-[0_4px_20px_rgba(0,0,0,0.1)] text-foreground border-0 py-4 h-auto" 
            variant="outline"
            disabled
          >
          ...
          <CardContent className="space-y-6">
            ...
            <div className="flex justify-center">
              <Calendar
                ...
                disabled={(date) => 
                  ...
                  (selectedDates.length >= 31 && !selectedDates.some(d => 
                    d.toDateString() === date.toDateString()
                  ))
                }
            ...
            <div className="space-y-4">
              ...
              <div className="flex flex-wrap gap-2">
                ...
                {showMoreMeals && additionalMeals.map((meal) => (
                  <Badge
                    key={meal}
                    variant={selectedMeals.includes(meal) ? "default" : "outline"}
                    className={cn(
