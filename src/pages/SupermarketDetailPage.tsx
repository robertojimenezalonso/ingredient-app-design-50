...
export default function SupermarketDetailPage() {
  ...
  const fetchMatchedProducts = async () => {
    ...
    try {
      ...
      const { data, error } = await supabase.functions.invoke('match-supermarket-products', {
        body: {
          supermarket,
      ...
      <div className="bg-white border-b sticky top-0 z-10">
        <div className="flex items-center justify-between p-4">
          ...
          <div className="flex items-center gap-3">
            <img 
              src={supermarketData.logo} 
              alt={supermarketData.name}
        ...
        <div className="px-4 py-3">
          ...
          <div className="w-full bg-gray-200 rounded-full h-2">
            <div 
              ...
              style={{ width: `${(checkedCount / products.length) * 100}%` }}
            />
          </div>
        </div>
      </div>
