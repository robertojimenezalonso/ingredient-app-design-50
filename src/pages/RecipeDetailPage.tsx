  ...
  return <div className="min-h-screen bg-background pb-24">
      ...
      <Tabs defaultValue="ingredientes" className="w-full">
        ...
        <TabsContent value="ingredientes" className="px-4 mb-8">
          ...
          {/* Optimization Banner */}
          {!isOptimized ? <Card className="mb-6 border border-gray-200">
              <CardContent className="p-4">
                <Collapsible open={isOptimizationOpen} onOpenChange={setIsOptimizationOpen}>
                  <CollapsibleTrigger asChild>
                    <div className="cursor-pointer text-left flex items-center justify-between">
                      <div>
                        <h3 className="font-semibold text-base text-foreground mb-0.5">
                          El {calculateAverageUsagePercentage()}% de los ingredientes se utilizan
                        </h3>
                        <p className="text-sm text-muted-foreground">
                          Bajo desperdicio de comida
                        </p>
                      </div>
                      <ChevronRight className={`h-5 w-5 text-muted-foreground transition-transform duration-200 ${isOptimizationOpen ? 'rotate-90' : ''}`} />
                    </div>
                  </CollapsibleTrigger>
                  ...
                  <CollapsibleContent className="mt-4">
                    <div className="space-y-3">
                      <p className="text-sm text-muted-foreground mb-4">
                        Si quieres optimizar tu receta al máximo, puedes:
                      </p>
                      
                      <div className="space-y-3">
                        <Card className="border border-gray-200">
                          <CardContent className="p-4 flex items-center justify-between">
                            <Label htmlFor="more-servings" className="text-sm font-normal flex-1 cursor-pointer">
                              Añadir 1 ración más por <span className="line-through text-muted-foreground">12,50 €</span> <span className="text-foreground font-medium">8,90 €</span> → Aprovecharás el 99% de los ingredientes
                            </Label>
                            <Checkbox checked={moreServingsChecked} onCheckedChange={checked => {
                          setMoreServingsChecked(!!checked);
                          if (checked) {
                            setOptimizationOption('more-servings');
                          } else if (optimizationOption === 'more-servings') {
                        ...
                        <Card className="border border-gray-200">
                          <CardContent className="p-4 flex items-center justify-between">
                            <Label htmlFor="bigger-portions" className="text-sm font-normal flex-1 cursor-pointer">Aumentar un 10% el tamaño de las raciones (GRATIS)
→ Aprovecharás el 100% de los ingredientes</Label>
                            <Checkbox checked={biggerPortionsChecked} onCheckedChange={checked => {
                          setBiggerPortionsChecked(!!checked);
                          if (checked) {
                            setOptimizationOption('bigger-portions');
                          } else if (optimizationOption === 'bigger-portions') {
                            setOptimizationOption(null);
                          }
                        }} id="bigger-portions" />
            ...
            </Card> : <Card className="mb-6 border border-gray-200">
              <CardContent className="p-4">
                <Collapsible open={isOptimizationOpen} onOpenChange={setIsOptimizationOpen}>
                  <CollapsibleTrigger asChild>
                    <div className="cursor-pointer text-left flex items-center justify-between">
                      <div>
                        <h3 className="font-semibold text-base text-foreground mb-0.5">
                          Receta optimizada al 99%
                        </h3>
                        <p className="text-sm text-muted-foreground">
                          {optimizationOption === 'more-servings' ? 'Se añadió 1 ración más' : 'Se aumentó el tamaño de las raciones un 10%'}
                        </p>
                      </div>
                      <ChevronRight className={`h-5 w-5 text-muted-foreground transition-transform duration-200 ${isOptimizationOpen ? 'rotate-90' : ''}`} />
                    </div>
                  ...
                  <CollapsibleContent className="mt-4">
                    <div className="space-y-3">
                      <p className="text-sm text-muted-foreground mb-4">
                        Cambiar optimización:
                      </p>
                      
                       <div className="space-y-3">
                         <Card className="border border-gray-200">
                           <CardContent className="p-4 flex items-center justify-between">
                              <Label htmlFor="more-servings-opt" className="text-sm font-normal flex-1 cursor-pointer">
                                Añadir 1 ración más por <span className="line-through text-muted-foreground">12,50 €</span> <span className="text-green-600 font-medium">8,90 €</span> → Aprovecharás el 99% de los ingredientes
                              </Label>
                             <Checkbox checked={moreServingsChecked} onCheckedChange={checked => {
                          setMoreServingsChecked(!!checked);
                          if (checked) {
                        ...
                        }} id="more-servings-opt" />
                           </CardContent>
                         </Card>
                         
                         <Card className="border border-gray-200">
                           <CardContent className="p-4 flex items-center justify-between">
                             <Label htmlFor="bigger-portions-opt" className="text-sm font-normal flex-1 cursor-pointer">Aumentar un 10% el tamaño de las raciones (GRATIS) → Aprovecharás el 100% de los ingredientes</Label>
                             <Checkbox checked={biggerPortionsChecked} onCheckedChange={checked => {
                          setBiggerPortionsChecked(!!checked);
                          if (checked) {
                            setOptimizationOption('bigger-portions');
