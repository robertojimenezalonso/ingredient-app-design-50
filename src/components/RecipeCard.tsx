    ...
    <div className={`relative overflow-visible h-[120px] ${isSwipeActive || isSwiped ? 'z-20' : 'z-10'}`}>
      ...
      <div className="flex-1 flex flex-col justify-start relative h-[120px] pt-3">
        <div className="flex items-start gap-2 mb-2 relative">
          <h3 className="font-medium text-lg leading-tight mt-2 max-w-[calc(100%-60px)] truncate whitespace-nowrap overflow-hidden">
            {recipe.title}
          </h3>
          {mealType && (
            <Badge variant="secondary" className="text-gray-600 text-xs px-2 py-1 absolute right-0 top-2" style={{ backgroundColor: '#F8F8FC' }}>
        ...
        <div className="mb-1.5">
          <div className="flex items-center gap-1 mb-2">
            ...
            <span className="text-sm text-black font-medium">{recipe.calories} kcal</span>
          </div>
