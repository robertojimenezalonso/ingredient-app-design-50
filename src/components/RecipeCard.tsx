...
export const RecipeCard = ({ recipe, onAdd, onClick, onDelete, onSubstitute, onSwipeStateChange, shouldResetSwipe, mealType }: RecipeCardProps) => {
  ...
  return (
    <div className={`relative overflow-visible h-40 ${isSwipeActive || isSwiped ? 'z-20' : 'z-10'}`}>
      ...
      <div 
        ...
        className="flex gap-3 items-center cursor-pointer relative rounded-xl bg-white w-full transition-transform duration-200 h-40 shadow-[0_4px_20px_rgba(0,0,0,0.1)] border border-border pr-4 py-2 mb-3"
      ...
      <div className="flex-1 flex flex-col justify-center relative h-40">
