  ...
  return (
    <div className={`relative overflow-visible h-20 ${isSwipeActive || isSwiped ? 'z-20' : 'z-10'}`}>
      ...
      <div 
        ...
        className="flex gap-3 items-center cursor-pointer mb-3 relative rounded-2xl bg-white mx-auto max-w-md last:mb-4 transition-transform duration-200 py-2 h-20"
