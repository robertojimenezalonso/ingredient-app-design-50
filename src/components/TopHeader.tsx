    ...
    <div className="pt-20" style={{
      ...
      <div className="mx-4 mb-8 mt-1 rounded-lg bg-white pb-1">
        ...
        <div className="flex gap-2 mx-4 mb-4 items-center">
          {/* Objetivo section */}
          <div className="rounded-lg py-1 px-3 flex-1 flex items-center justify-center" style={{
            backgroundColor: '#E8F5E8'
          }}>
            <span className="text-sm text-green-600 text-center">Comer saludable</span>
          </div>

          {/* Better Price Section */}
          <div className="rounded-lg px-3 py-1 flex-1 flex items-center justify-center" style={{
