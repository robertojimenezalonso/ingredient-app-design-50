    ...
    <div className="pt-20" style={{
      ...
      <div className="mx-4 mb-8">
        <div className="flex items-center justify-center gap-4">
          <span className="text-sm whitespace-nowrap text-black">Mejor precio: <span>{(totalPrice * 0.8).toFixed(2).replace('.', ',')} €</span> · <span className="text-green-600">-{(totalPrice * 0.2).toFixed(2).replace('.', ',')} €</span></span>
        </div>
      </div>
