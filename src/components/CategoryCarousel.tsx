...
export const CategoryCarousel = ({
  ...
  return <div className="mb-4">
      <div className="fixed left-0 right-0 px-4 space-y-6 bg-white pb-32 overflow-y-auto h-screen z-10" style={{ top: 'calc(env(safe-area-inset-top) + 80px)', paddingTop: '80px' }}>
        {mealPlan.map(({
        date,
        dateStr,
        meals
      }) => <div key={dateStr} className="space-y-2" ref={el => {
