...
export const CategoryCarousel = ({
  ...
  return <div className="mb-4">
      <div className="fixed left-0 right-0 px-4 space-y-6 pb-32 overflow-y-auto h-screen z-0" style={{ top: 'calc(env(safe-area-inset-top) + 80px)', paddingTop: '80px', backgroundColor: '#F5F5F8' }}>
        {mealPlan.map(({
        date,
        dateStr,
        meals
