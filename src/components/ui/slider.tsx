...
>(({ className, trackColor, rangeColor, thumbColor, ...props }, ref) => (
  ...
  >
    <SliderPrimitive.Track 
      ...
      style={{ backgroundColor: trackColor || 'hsl(var(--secondary))' }}
    >
      <SliderPrimitive.Range 
        className="absolute h-full" 
        style={{ backgroundColor: rangeColor || 'hsl(var(--primary))' }}
      />
    </SliderPrimitive.Track>
    <SliderPrimitive.Thumb 
      ...
      style={{ borderColor: thumbColor || rangeColor || 'hsl(var(--primary))' }}
    />
  </SliderPrimitive.Root>
))
